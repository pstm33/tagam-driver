...
export default {
  ...
  methods: {
    getLicensePhoto() {
      this.loading = true;
      APIinterface.fetchDataByToken("getLicensePhoto")
        .then((data) => {
          this.front_photo_filename = data.details.license_front_photo;
          this.front_photo_url = data.details.front_photo_url;
          this.upload_path = data.details.upload_path;

          this.back_photo_filename = data.details.license_back_photo;
          this.back_photo_url = data.details.back_photo_url;
        })
        .catch((error) => {})
        .then((data) => {
          this.loading = false;
    ...
    uploadLicensePhoto() {
      ...
      APIinterface.fetchDataByToken("updatelicensephoto", {
        ...
        .then((data) => {
          ...
          //this.$router.replace("/account/documents");
        })
        .catch((error) => {
